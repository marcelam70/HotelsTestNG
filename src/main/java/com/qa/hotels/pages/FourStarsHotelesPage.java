...
public class FourStarsHotelesPage extends BasePage{
	WebDriver driver;
	...
	public FourStarsHotelesPage(WebDriver driver) {
		this.driver = driver;
		elementUtil = new ElementUtil(driver);
	}

	public String getFourStarPageTitle() {
		System.out.println(driver.getTitle());
		return driver.getTitle();

	}

	public void select4StarHotel() throws InterruptedException {
	...
	public FiveStarsHotelsPage switchPage() throws InterruptedException {

		return new FiveStarsHotelsPage(driver);
	}
